...
<div class="card1Text">
  ...
  <ul>
   <li ><a href="client.php" id="tag" >CLIENTS</a></li>
   <li><a href="matter.php" id="tag">MATTERS</a></li>
   <li><a href="attorney.php" id="tag">ATTORNEY</a></li>
    <li><a href="finance.php" id="tag">FINANCE</a></li>
    <li><a href="calendar.php" id="tag">DIARY</a></li>
